...
Purpose:
    ...
    - For customer segmentation and product categorization.
...
Group customers into three segments based on their spending behavior:
    ...
    Regular:
        Customers with at least 12 months of history
        AND spending 5,000 or less.

    New:
        Customers with a lifespan of less than 12 months.

Then find the total number of customers in each segment.
-------------------------------------------------------------------------------
*/
...
WITH customer_spending AS (
    SELECT
        ...
        -- MySQL equivalent of DATEDIFF(month, ...)
        TIMESTAMPDIFF(
            MONTH,
            MIN(f.order_date),
            MAX(f.order_date)
